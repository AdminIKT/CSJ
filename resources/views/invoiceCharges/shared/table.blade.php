  ...
  <table class="table table-hover table-sm">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            {{ Form::open([
                'route' => ['invoiceCharges.destroy', $entity->getId()], 
                'method' => 'delete',
            ]) }}
                <div class="btn-group btn-group-sm" role="group">
                    <a href="{{ route('invoiceCharges.show', ['invoiceCharge' => $entity->getId()]) }}" class="btn btn-outline-secondary disabled" title="{{ __('View') }}">
                        <span data-feather="eye"></span>
                    </a>
                    <a href="{{ route('invoiceCharges.edit', ['invoiceCharge' => $entity->getId()]) }}" class="btn btn-outline-secondary disabled">
