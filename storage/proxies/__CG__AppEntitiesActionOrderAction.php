...
namespace DoctrineProxies\__CG__\App\Entities\Action;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class OrderAction extends \App\Entities\Action\OrderAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'action' => NULL,
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Action\\OrderAction' . "\0" . 'entity', 'id', 'type', 'action'];
        }

        return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Action\\OrderAction' . "\0" . 'entity', 'id'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderAction $proxy) {
    ...
    public function typeName($type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'typeName', [$type]);
