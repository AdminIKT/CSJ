 ...
 */
class Invoiced extends \App\Entities\Supplier\Invoiced implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'year', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'credit', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'supplier', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'created', '' . "\0" . 'App\\Entities\\Supplier\\Invoiced' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Invoiced $proxy) {
