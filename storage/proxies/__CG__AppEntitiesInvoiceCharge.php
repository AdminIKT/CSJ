 ...
 */
class InvoiceCharge extends \App\Entities\InvoiceCharge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\InvoiceCharge' . "\0" . 'order', '' . "\0" . 'App\\Entities\\InvoiceCharge' . "\0" . 'invoice'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InvoiceCharge $proxy) {
